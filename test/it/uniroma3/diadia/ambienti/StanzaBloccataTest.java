...
public class StanzaBloccataTest {
	...
	public void setUp() throws Exception {
		...
		this.stanzaBloccata = new StanzaBloccata("N11","nord","piediporco");
		this.stanzaAdiacenteNord = new Stanza("N12");
		this.stanzaAdiacenteSud = new Stanza("N10");
		this.stanzaBloccata.impostaStanzaAdiacente("nord", this.stanzaAdiacenteNord);
		this.stanzaBloccata.impostaStanzaAdiacente("sud", this.stanzaAdiacenteSud);
	...
	public void testGetStanzaAdiacenteSenzaAttrezzo() {
		...
		assertEquals(this.stanzaAdiacenteSud, this.stanzaBloccata.getStanzaAdiacente("sud"));
	}
	
	@Test
	public void testGetStanzaAdiacenteConAttrezzoPerSbloccare() {
		this.stanzaBloccata.addAttrezzo(this.piediporco);
		assertEquals(this.stanzaAdiacenteNord, this.stanzaBloccata.getStanzaAdiacente("nord"));
		assertEquals(this.stanzaAdiacenteSud, this.stanzaBloccata.getStanzaAdiacente("sud"));
	}
